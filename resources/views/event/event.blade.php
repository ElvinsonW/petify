            ...
            <div class="flex flex-col">
                ...
                <form class="mt-[1vw]">
                    <div class="relative mb-8">
                        ...
                        <div class="relative w-full rounded-[0.5vw] bg-abuevent">
                            <div class="absolute inset-y-0 start-0 flex items-center ps-[0.75vw] pointer-events-none">
                                <i class="fa-solid fa-magnifying-glass"></i>
                            </div>
                            <input type="search" id="search" class="rounded-[0.5vw] block w-full max-w-[calc(100%-5.2vw)] p-[1vw] ps-10 !font-overpass font-semibold focus:outline-none bg-abuevent" placeholder="Search Here..." required/>
