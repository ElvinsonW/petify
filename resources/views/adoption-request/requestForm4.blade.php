<div class="w-full mt-10 mb-32 bg-no-repeat bg-center bg-contain px-4" style="background-image: url(../src/images/form-bg.png)">
    ...
    <div id="steps" class="flex justify-center items-center gap-4 font-open_sans mb-16">
        ...
        <div id="step-4" class="flex flex-col items-center">
            <div class="w-8 h-8 flex items-center justify-center rounded-full border-2 border-greenpetify bg-white text-greenpetify font-bold transition-all duration-500">4</div>
        </div>
    ...
    <div class="flex justify-center">
        <div class="w-2/3 flex flex-col justify-center">
            <div>
                <label for="description4" class="block mb-5 text-xl font-semibold text-center">
                    Do you have a yard or outdoor space for animals?                  
                </label>
                <textarea wire:model="description4" id="description4" rows="15" class="border border-black  text-sm rounded-lg block w-full p-2.5 focus:outline-none" placeholder="Write pet description here..." required></textarea>
                @error('description4') 
