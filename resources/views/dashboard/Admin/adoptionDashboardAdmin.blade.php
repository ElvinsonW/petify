...
<x-dashboard.layout :user="$user">
    ...
    <div class="flex-1 p-[2vw] h-screen flex flex-col">
        ...
        <div class="flex flex-row mt-[1.5vw] space-x-[2vw]">
            ...
            @endphp
            <a href="{{ url('/dashboard/adoption-post-requests') . '?' . http_build_query($queryParams) }}" class="flex items-center {{ !request('status') ? 'bg-white' : '' }} bg-abuevent px-[2vw] py-[1.5vw] rounded-tl-[1.5vw] rounded-tr-[1.5vw] w-[20vw]">
            ...
            @endphp
            <a href="{{ url('/dashboard/adoption-post-requests') . '?' . http_build_query($queryParams) }}" class="{{ request()->query('status') == "Accepted" ? 'bg-white' : '' }} flex items-center bg-abuevent px-[2vw] py-[1.5vw] rounded-tl-[1.5vw] rounded-tr-[1.5vw] w-[20vw]">
            ...
            @endphp
            <a href="{{ url('/dashboard/adoption-post-requests') . '?' . http_build_query($queryParams) }}" class="{{ request()->query('status') == "Rejected" ? 'bg-white' : '' }} flex items-center bg-abuevent px-[2vw] py-[1.5vw] rounded-tl-[1.5vw] rounded-tr-[1.5vw] w-[20vw]">
                        ...
                        @if ($request->approval_status === "Pending")    
                            <div class="flex space-x-[0.5vw]">
                                <button class="bg-blue-200 p-[1vw] rounded-md flex items-center justify-center w-[2.5vw] h-[2.5vw]">
                                    <a href="/dashboard/adoption-post-requests/{{ $request->slug }}">
                                ...
                                <button class="bg-greenabout p-[1vw] rounded-md flex items-center justify-center w-[2.5vw] h-[2.5vw]">
                                    <a href="/dashboard/adoption-post-requests/{{ $request->slug }}/accept">
                                ...
                                <button class="bg-red-200 p-[1vw] rounded-md flex items-center justify-center w-[2.5vw] h-[2.5vw]">
                                    <a href="/dashboard/adoption-post-requests/{{ $request->slug }}/reject">
