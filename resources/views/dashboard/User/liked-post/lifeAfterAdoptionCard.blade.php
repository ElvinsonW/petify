    ...
    @foreach ($posts as $post)    
        <a href="/life-after-adoption">
            <div class="w-full h-full flex flex-col items-center">
                <div class="w-[13.5vw] h-[27vh] relative">
                    <img src="{{ asset('storage/' . $post->life_after_adoption->image) }}" alt="Pet Post" class="w-full h-full object-cover">
                    <div class="w-full pb-[0.5vw] pl-[0.5vw] flex gap-[0.5vw] items-center mt-[-2.3vw]">
                        ...
                        <p class="text-white text-center items-center font-semibold tracking-tight font-overpass text-[0.8vw]">{{ $post->life_after_adoption->like_count }} Like</p>
                    </div>
                </div>
            </div>
        </a>
