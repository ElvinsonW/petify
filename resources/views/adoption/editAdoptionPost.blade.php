            ...
            <form id="editForm" action="/adoptions/{{ $adoption->slug }}" method="post" enctype="multipart/form-data">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2 font-open_sans">
                    ...
                    <div>
                        ...
                        <input type="text" id="slug" name="slug" class="border border-black text-sm rounded-lg block w-full p-2.5 focus:outline-none" placeholder="Slug..." value="{{ old('slug', $adoption->slug) }}" required />
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <trix-editor toolbar="custom-toolbar" input="description" class="h-[250px]"></trix-editor>
