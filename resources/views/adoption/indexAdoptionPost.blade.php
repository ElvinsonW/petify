<x-layout>
    @if (session('ownerError'))
        ...
        <div id="alert-2" class="flex items-center p-[1vw] mb-[1vw] text-red-800 rounded-[0.5vw] bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
    ...
    @elseif (session('createSuccess'))
        ...
        <div id="alert" 
            class="absolute z-40 flex items-center justify-center p-4 mb-[1vw] w-[30vw] text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" 
